package com.example.etourismuttrakhand.ui.feature_details_screen.backend
...
fun ViewPager2.autoScroll(interval: Long) {
    ...
    fun LinearLayoutManager.autoScroll(interval: Long){
        val handler = Handler()
        var scrollPosition = 0
        ...
        val runnable = object : Runnable {
            ...
            override fun run() {
                    ...
                    this@autoScroll.apply {
                        val count = itemCount
                        scrollToPositionWithOffset(scrollPosition++ % count,0)
                    }
...
//    )
    ...
    val whyVisit = listOf(
        DetailImage(image = R.drawable.whyvisituk1),
        DetailImage(image = R.drawable.whyvisituk2),
        DetailImage(image = R.drawable.whyvisituk3),
        DetailImage(image = R.drawable.whyvisituk4),
        DetailImage(image = R.drawable.whyvisituk5),
        DetailImage(image = R.drawable.whyvisituk6),
    )
